...
<IcdGroupItem
  label="+ Bệnh chính:"
  v-model="data.IcdRaVienBenhChinh"
  v-model:ten="data.IcdRaVienBenhChinhTen"
  v-model:ma="data.IcdRaVienBenhChinhMa"
/>

<IcdGroupItem
  v-model="data.IcdYHCT"
  type="YHCT"
  v-model:ten="data.IcdYHCTTen"
  v-model:ma="data.IcdYHCTMa"
/>
```
...
<IcdList :items="data.ListIcdRaVienBenhKemTheo" />

<div>+ ICD YHCT:</div>
<IcdList
  type="YHCT"
  :items="data.ListIcdYHCT"
/>
```
...
<Textarea label="Họ tên:" v-model="text" line :rows="1" />
```
